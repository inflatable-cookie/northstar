...
requireContains(repoRoot, "docs/README.md", "specs/018-consumer-repo-follow-up-queue-and-underlay-recovery.md", "active spec front door");
requireContains(repoRoot, "docs/README.md", "roadmaps/g02/015-queue-deferred-strict-follow-ups-and-open-underlay-recovery.md", "active roadmap front door");
requireContains(repoRoot, "docs/README.md", "Let Underlay execute `g01.098` Batch 98.2", "live docs next task");
requireContains(repoRoot, "docs/roadmaps/README.md", "`g02` is the active generation", "roadmaps active generation");
requireContains(repoRoot, "docs/roadmaps/README.md", "`g02.014` is the current milestone", "roadmaps active milestone");
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "015-queue-deferred-strict-follow-ups-and-open-underlay-recovery.md", "g02 milestone listing");
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "Let Underlay execute `g01.098` Batch 98.2", "g02 next task");
requireContains(repoRoot, "docs/roadmaps/generation-index.md", "Underlay runs `g01.098` Batch 98.2", "generation index next task");
requireContains(repoRoot, "docs/contracts/contract-index.md", "`g02.014` is the current lane", "contract index current lane");
...
requireContains(repoRoot, "docs/logs/README.md", "Let Underlay execute `g01.098` Batch 98.2", "logs next task");
...
requireContains(repoRoot, "docs/specs/README.md", "g01.098` proves the", "specs README next task");
