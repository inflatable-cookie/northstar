...
requireContains(repoRoot, "docs/README.md", "specs/016-strict-compliance-audit-and-rollout.md", "active spec front door");
requireContains(repoRoot, "docs/README.md", "roadmaps/g02/013-define-strict-compliance-audit-and-rollout-surface.md", "active roadmap front door");
requireContains(repoRoot, "docs/README.md", "Start `g02.013` batch `13.3`", "live docs next task");
requireContains(repoRoot, "docs/roadmaps/README.md", "`g02` is the active generation", "roadmaps active generation");
requireContains(repoRoot, "docs/roadmaps/README.md", "`g02.013` is the current milestone", "roadmaps active milestone");
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "013-define-strict-compliance-audit-and-rollout-surface.md", "g02 milestone listing");
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "Start `g02.013` batch `13.3`", "g02 next task");
requireContains(repoRoot, "docs/roadmaps/generation-index.md", "Start `g02.013` batch `13.3`", "generation index next task");
requireContains(repoRoot, "docs/contracts/contract-index.md", "`g02.013` is the current lane", "contract index current lane");
...
requireContains(repoRoot, "docs/logs/README.md", "10-201500-apply-audit-and-rollout-guidance.md", "latest active-lane log");
requireContains(repoRoot, "docs/logs/README.md", "Start `g02.013` batch `13.3`", "logs next task");
...
requireContains(repoRoot, "docs/specs/README.md", "Start `g02.013` batch `13.3`", "specs README next task");
