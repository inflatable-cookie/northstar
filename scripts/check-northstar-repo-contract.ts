...
requireContains(repoRoot, "docs/README.md", "specs/017-signal-strict-compliance-migration-proof.md", "active spec front door");
requireContains(repoRoot, "docs/README.md", "roadmaps/g02/014-prove-strict-compliance-migration-in-signal.md", "active roadmap front door");
requireContains(repoRoot, "docs/README.md", "Open a Signal-owned migration lane", "live docs next task");
...
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "014-prove-strict-compliance-migration-in-signal.md", "g02 milestone listing");
requireContains(repoRoot, "docs/roadmaps/g02/README.md", "Open a Signal-owned migration lane", "g02 next task");
requireContains(repoRoot, "docs/roadmaps/generation-index.md", "Open a Signal-owned migration lane", "generation index next task");
...
requireContains(repoRoot, "docs/logs/README.md", "Open a Signal-owned migration lane", "logs next task");
...
requireContains(repoRoot, "docs/specs/README.md", "Open a Signal-owned migration lane", "specs README next task");
