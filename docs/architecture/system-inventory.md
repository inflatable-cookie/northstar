...
| `docs/triage/` | mutable temporary conversational capture surface | Chatterbox/Oracle/refresh/cleanup modes | timestamped non-authoritative notes kept current in place and pruned on promotion | triage contract, refresh lifecycle, cleanup route |
...
| Oracle consultation | optional bounded frontier planning and evidence challenge | operator + Oracle, under Chatterbox planning authority | minimal dossier or one unique triage note | issue-scoped consultation, redacted dossier, return to Chatterbox |
...
| Frontier Oracle consultation | operator request or Chatterbox escalation for one bounded question | minimal redacted dossier and advisory return to Chatterbox | `001-working-rules`, `skills/northstar/references/modes/chatterbox.md` | Oracle may challenge evidence and options but has no canonical/readiness/dispatch/PR/merge authority |
...
| Operator-confirmed planning promotion | Chatterbox-reconciled meaning + explicit operator confirmation | canonical ready plan committed directly on integration branch | `001-working-rules`, `skills/northstar/references/modes/chatterbox.md` | No promotion worker; exceptional independent planning review only for operator request or named residual risk |
