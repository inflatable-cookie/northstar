...
| documentation projection subagent | mechanical planning-doc projection | orchestrator | exact named docs, templates, indexes, parity, and deterministic evidence from a settled brief or an operator-confirmed decision-ready packet; stops on semantic ambiguity | orchestrator projection template, full diff review, promotion review child, no Git/provider authority |
