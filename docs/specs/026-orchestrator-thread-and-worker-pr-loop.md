...
| Chatterbox | direct operator intake conversation, problem exploration, unique triage-file capture on shared checkout (automated pings paused pending atomic queue) | canonical planning, readiness, implementation, review, merge, worker dispatch, or a reserved topic |
