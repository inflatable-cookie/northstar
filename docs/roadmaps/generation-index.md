...
compiled into `g02.048`. Card 116 is complete (machine contracts frozen and
validated); cards 117-120 form the dependency-ordered fixture-lifecycle,
TypeScript, Rust, and embedded-removal runway.
