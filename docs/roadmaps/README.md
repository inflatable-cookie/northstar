...
- `g02.049` is active; card 123 is in revision after exact-head review rejected
  its prose-coupled checker while accepting the cross-workspace child rule.
...
Finish card 123's bounded review revision first. Card 120 stays ready but serial
behind its reviewed merge and installed-skill refresh.
