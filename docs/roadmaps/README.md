...
- `g02.051` has card 125 complete: economical coordination is the
...
Publish card 126's bounded observation packet and stop date. Its merge,
installed-skill, and Paseo-profile prerequisites are complete.
