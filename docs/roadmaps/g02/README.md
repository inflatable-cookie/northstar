...
| Consolidate bundle doctrine, templates, skills, and checks so the reusable system stays copy-ready. | active | `bundle-docs/protocol-kernel.md`, `template-bundle/README.md`, `skills/northstar/SKILL.md` | `g02.046/114` awaiting review |
...
- `046-add-fresh-orchestrator-continuation.md` (active; card 114 implementation
  complete, awaiting exact-head review)

## Next Task

Review the `g02.046/114` PR at its exact head. Spec 034 remains a separate
