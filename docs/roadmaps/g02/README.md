...
| Make Chatterbox the human planning authority while the coordinator mechanically dispatches approved frontiers and gates PRs. | card 128 complete in review | `docs/specs/037-chatterbox-led-planning-and-mechanical-coordination.md`, `docs/contracts/001-working-rules.md`, `docs/roadmaps/g02/053-chatterbox-led-planning-and-mechanical-coordination.md` | review and merge card 128 |
