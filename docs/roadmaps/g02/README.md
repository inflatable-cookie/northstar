...
| Consolidate bundle doctrine, templates, skills, and checks so the reusable system stays copy-ready. | active | `bundle-docs/protocol-kernel.md`, `template-bundle/README.md`, `skills/northstar/SKILL.md` | review Convergence Rust package canary |
...
| Raise language-code quality through evidence-bound routed workflows without making every implementation part of the root payload. | active | `docs/contracts/004-language-quality-pack.md`, `docs/architecture/system-architecture.md`, `docs/roadmaps/g02/048-extract-modular-language-quality-packages.md` | Convergence consumer canary in flight |
...
- `048-extract-modular-language-quality-packages.md` (active; cards 117-118
  ...
  merged as `256d0f7`; the Convergence consumer canary is in flight, and card
  120 remains blocked behind Rust consumer proof)
...
merged as `256d0f7`. Review the in-flight Convergence `g02.031/102` consumer
