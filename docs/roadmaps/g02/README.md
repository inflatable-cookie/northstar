...
- `043-prefer-economical-worker-routing.md` (active; card 111 ready)

## Next Task

Dispatch `g02.043/111`. Signal papercut closure remains an independent
