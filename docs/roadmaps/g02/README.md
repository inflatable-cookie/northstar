...
| Make the orchestrator an economical coordinator while planning and semantic review use separate capable threads. | card 125 implemented; PR open | `docs/specs/036-economical-orchestrator-coordination.md`, `docs/specs/026-orchestrator-thread-and-worker-pr-loop.md`, `docs/contracts/001-working-rules.md` | exact-head review, merge, and installed-skill refresh |
...
- `050-add-chatterbox-intake-channel.md` (complete; card 124 merged through PR
  31 at `d1b162e`)
- `051-economical-orchestrator-coordination.md` (card 125 implemented; PR
  open; card 126 blocked behind merge and installed-skill refresh)

## Next Task

Review and merge card 125's economical-coordination PR at its exact head, then
refresh the installed skill. Card 126 remains blocked until both complete. The
Sentrux triage note and any new-language cohort remain separate operator
checkpoints.
