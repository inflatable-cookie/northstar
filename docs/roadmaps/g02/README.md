...
| Consolidate bundle doctrine, templates, skills, and checks so the reusable system stays copy-ready. | active | `bundle-docs/protocol-kernel.md`, `template-bundle/README.md`, `skills/northstar/SKILL.md` | re-review Convergence Rust package canary |
...
| Raise language-code quality through evidence-bound routed workflows without making every implementation part of the root payload. | active | `docs/contracts/004-language-quality-pack.md`, `docs/architecture/system-architecture.md`, `docs/roadmaps/g02/048-extract-modular-language-quality-packages.md` | Convergence consumer canary changes required |
...
- `048-extract-modular-language-quality-packages.md` (active; cards 117-118
  ...
  merged as `256d0f7`; Convergence PR 4 has a bounded pre-extraction-evidence
  oracle gap, and card 120 remains blocked behind accepted Rust consumer proof)
...
merged as `256d0f7`. Re-review Convergence PR 4 after its retained worker
repairs the pre-extraction-evidence oracle; card 120 remains serial behind it.
