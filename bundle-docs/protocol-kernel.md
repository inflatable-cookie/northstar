...
| Economical coordinator coordination (mechanical coordination, dispatch manifest, review child in worker workspace, coordination gate) | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Economical coordinator coordination** | `docs/contracts/001-working-rules.md` plus the installed coordinator and PR-review modes |
| Paseo worker parentage and cross-workspace child dispatch | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Parallel lane scheduling** | `docs/contracts/001-working-rules.md` plus the installed coordinator mode |
| Planning-risk check and optional frontier second opinion | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Planning-risk check and optional frontier second opinion** | `docs/contracts/001-working-rules.md` plus the installed chatterbox and coordinator modes |
| Fresh coordinator continuation | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Fresh coordinator continuation** | `docs/contracts/001-working-rules.md` plus the generic seven-section handoff with `coordinator-continuation` activation |
