...
| Economical orchestrator coordination (coordinator default, decision-ready packets, independent review children, coordination gate) | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Economical orchestrator coordination** | `docs/contracts/001-working-rules.md` plus the installed orchestrator and PR-review modes |
...
| Chatterbox intake channel | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Chatterbox intake channel** | `docs/contracts/001-working-rules.md` plus the installed chatterbox mode |
