...
| Frontier Oracle and decision-risk gate | [sections/07-delivery-framework-and-autonomy.md](./sections/07-delivery-framework-and-autonomy.md) — see **Frontier Oracle and decision-risk gate** | `docs/contracts/001-working-rules.md` plus the installed chatterbox and coordinator modes |
